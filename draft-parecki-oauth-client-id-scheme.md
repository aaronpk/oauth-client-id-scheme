...
This specification defines the concept of a Client Identifier Scheme to enable supporting Authoriztion Servers and Clients to use more than one mechanism to obtain and validate Client metadata.
